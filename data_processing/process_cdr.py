...
def main(input_path):
    ...
    for d in sets:
        ...
        # subprocess.run([
        #     "python3", "filter_hypernyms.py",
        #     "--mesh_file", "2017MeshTree.txt",
        #     "--input_file", f"{input_path}/{d}.data",
        #     "--output_file", f"{input_path}/{d}_filter.data",
        #     "--debug_file", f"{input_path}/{d}_debug_output.csv"  # Add the debug file path here
        # ])
