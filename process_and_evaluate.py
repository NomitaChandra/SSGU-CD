...
os.chdir("/Users/kavithakamarthy/Downloads/SSGU-CD/data_processing")
subprocess.run(["python", "process_cdr.py", "/Users/kavithakamarthy/Downloads/SSGU-CD/dataset/cdr"])
...
model.to('cpu')
model_path = '/Users/kavithakamarthy/Downloads/SSGU-CD/out/train_filter_bert_cdr_seed_BSCELoss_tree_0.3_0.5_66_best'
